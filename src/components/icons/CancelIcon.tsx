...
export const CancelIcon: FC = () => {
    return (
        <svg height="20px" width="20px" viewBox="0 0 512 512" version="1.1" xmlns="http://www.w3.org/2000/svg"
             fill="#ffff" stroke="#ffff">
            <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
            <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
            <g id="SVGRepo_iconCarrier"><title>cancel</title>
                <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                    <g id="work-case" fill="#ffff" transform="translate(91.520000, 91.520000)">
                        <polygon id="Close"
